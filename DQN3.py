...
class DQN3:
    def __init__(self, params):
        ...
        self.o2_flat = tf.reshape(self.o2, [-1, dim], name=self.network_name + '_flatten')

        # Layer 3 (Fully connected, Output layer)
        layer_name = 'fc3'; hiddens = 4
        ...
        self.y = tf.add(tf.matmul(self.o2_flat, self.w3), self.b3, name=self.network_name + '_' + layer_name + '_outputs')
